      ...
      <section id="intro" class="textIntro introSideButtons backgroundDark">
         <div class="wrapper wrapperSmall">
            ...
            <div class="introButtons">
               <a aria-label="Zu der Startseite" href="index.php" class="button">Home</a>
               <a aria-label="Weiter zu der Unterseite Fähigkeiten" href="faehigkeiten.php" class="button">Fähigkeiten</a>
               <a aria-label="Weiter zu der Unterseite über mich" href="ueber-mich.php" class="button">Über Mich</a>
            </div>
            <span>
               <p>
               ...
               <p>
                  ...
                  https://www.google.com/intl/de/tagmanager/use-policy.php.
               </p>
               <h3>
                  Haftungsausschluss
               </h3>

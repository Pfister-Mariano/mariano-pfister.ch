...
<nav id="navigation">
    <div class="wrapper">
        ...
        <menu>
        <li class="navHome">
            <a aria-label="Link zu der Startseite" href="index.php">
        ...
        <menu class="navMain">
        <li><a aria-label="Weiter zu der Unterseite Fähigkeiten" href="faehigkeiten.php">Fähigkeiten</a></li>
        <li><a aria-label="Weiter zu der Unterseite Bewerbung" href="bewerbung.php">Bewerbung</a></li>
        <li><a aria-label="Weiter zu der Unterseite über mich" href="ueber-mich.php">Über Mich</a></li>
        </menu>
    </div>
</nav>